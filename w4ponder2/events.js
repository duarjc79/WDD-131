...
// We need to attach listeners to the submit button and the list. Listen for a click, call the 'newTask' function on submit and call the 'manaeTass' fnction if either of the icons are clicked in the list of tasks.
